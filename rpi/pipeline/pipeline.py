...
"""
5-second loop:
  1. Receive mic audio from STM32 via UART (PA9 → RPi pin 10)
  2. Save as 16kHz WAV
  3. Stream back via SPI for playback (RPi GPIO10/11/8 → STM32 PB15/13/12)
"""
...
"""RAW_WAV        = '/tmp/raw.wav'
OUT_WAV        = '/tmp/out_16k.wav'"""

RAW_WAV = '/home/edgemd/final-project-edge-md/rpi/pipeline/raw.wav'
OUT_WAV = '/home/edgemd/final-project-edge-md/rpi/pipeline/out_16k.wav'
...
def stream_back():
    ...
    # flush silence to drain STM32 buffer
